...
<div class="container">
    <div class="row">
        ...
        @if ($books->count())
          <form action="/list-books" method="GET">
              <div class="row mt-3">
                  <div class="col-6">
                  ...
                  <div class="col-6">
                      <div class="input-group mb-3">
                          <input type="text" class="form-control" name="title" id="title" value="{{ request('title') }}" placeholder="Title Book">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 my-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p
                        class="text-end fw-bold {{ ($item->status == 'in stock') ? 'text-success' : 'text-danger' }}">
                        {{ $item->status }}
                    </p>
                </div>
            </div>
